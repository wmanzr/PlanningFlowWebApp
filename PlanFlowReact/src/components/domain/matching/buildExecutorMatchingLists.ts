import type { MatchTaskResponseDto, RankedCandidateResponseDto, RejectedCandidateResponseDto, UserResponseDto, } from '@/types';
export type LeftMatchingListItem = {
    kind: 'overflow-ranked';
    ...
    kind: 'rejected';
    rejection: RejectedCandidateResponseDto;
};
