...
@Service
@Transactional
public class MarkResourceOperationalService implements MarkResourceOperationalUseCase {

    private final InternalResourceRepositoryPort internalResourceRepository;

    public MarkResourceOperationalService(final InternalResourceRepositoryPort internalResourceRepository) {
